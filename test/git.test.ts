...
test('parse', async () => {
  ...
  expect(md.replace(/&nbsp;/g, ' ').replace(/[ ]+/g, ' ')).toMatchInlineSnapshot(`
    ...
    - **cli**: Rename \`groupByScope\` to \`group\` - by **Enzo Innocenzi** in https://github.com/antfu/changelogithub/issues/22
    ...
    - Improve how references are displayed - by **Enzo Innocenzi** in https://github.com/antfu/changelogithub/issues/19
    - Support \`--no-emoji\` - by **Enzo Innocenzi** in https://github.com/antfu/changelogithub/issues/20
    - **contributors**:
     - Improve author list - by **Enzo Innocenzi** in https://github.com/antfu/changelogithub/issues/18
    - **style**:
    ...
    - Use \`creatordate\` to sort tags - by **Frost Ming** in https://github.com/antfu/changelogithub/issues/17
    ...
    - **cli**: Add missing \`--group\` option - by **Enzo Innocenzi** in https://github.com/antfu/changelogithub/issues/21
